...
for datafile in all_files:
    with open(datafile, "r") as f:
        ...
        for each in data:
            # Print some sample data -- IssueCommentEvent PushEvent CreateEvent IssuesEvent ReleaseEvent DeleteEvent
            ...
            if each["type"] == "IssueCommentEvent":
                ...
                #     each["payload"]["comment"]["created_at"]
                # )
